#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Vendored verbatim from the official ImageCLEF 2026 starter kit:
# https://github.com/mbzuai-nlp/ImageCLEF-MultimodalReasoning/blob/main/2026/src/evaluation/evaluate_qa.py
# Copyright belongs to the competition organizers. Kept in-tree so local dev
# scoring does not require cloning the starter kit.
